...
if __name__ == "__main__":
    # parse arguments
    # example: `python3 run_game_v2_battle_dqcnn_local.py -n 64 64 -i 5`
    ...
    assert log_id < 1000
    filename = 'battle-dqcnn-{:0>3}-local.log'.format(log_id)
    logger = logging.Logger("DQCNNLogger")
    ...
    agent = DQCNNAgent(state_size, action_size, **kwargs)
    wins = []
    rewards = []
    ...
    model_path = 'battle-dqcnn-{:0>3}-local.h5'.format(log_id)
